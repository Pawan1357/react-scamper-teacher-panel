...
import { useResetPassword } from 'modules/Auth/Modules/ResetPassword/hooks/useResetPassword.ts';
...
export const ResetPasswordForm = () => {
  const { form, navigate, onSubmit, isFormValid, isPending, onFieldsChange } = useResetPassword();
  return (
    <Form
        ...
        <InputWrapper>
          <div>
            <LabelWithInfo
              ...
              info="Your new password must be at least 8 characters and contain at least 1 special character, 1 number and 1 capital letter."
            />
            <RenderPasswordInput
              formItemProps={{
                name: 'new_password',
